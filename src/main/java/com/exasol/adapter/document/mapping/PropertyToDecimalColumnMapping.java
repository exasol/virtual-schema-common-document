...
public final class PropertyToDecimalColumnMapping extends AbstractPropertyToColumnMapping {
    ...
    public ColumnMapping withNewExasolName(final String newExasolName) {
        return new PropertyToDecimalColumnMapping(newExasolName, getPathToSourceProperty(), getLookupFailBehaviour(),
                this.decimalPrecision, this.decimalScale, this.overflowBehaviour, this.notNumericBehaviour);
    }
